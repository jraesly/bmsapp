$(document).ready(function(){
	...
	$('#note-submit').live('click',function(e){
		...
		$(this).replaceWith('<img src="../assets/img/ajax-loader.gif" style="margin:30px auto;display:block" />');
		...
		$.post('../lib/pnp/stickynote/ajax/post.php',data,function(msg){
...
function make_draggable(elements)
{
	...
	elements.draggable({
		...
		stop:function(e,ui){
			...
			$.get('../lib/pnp/stickynote/ajax/update_position.php',{
				  x		: ui.position.left,
				  y		: ui.position.top,
				  z		: zIndex,
