...
if (!defined("_APP_RUN"))
	...
	$ltUrl= lc('sysUrl');
$ltUrl= $ltUrl.'/redirect'.EXT.'?_ref=';
//This is where you enter in your information
define('ZIPSME_DB_USER', $db_user); //Your database user name
define('ZIPSME_DB_PASSWORD', $db_password); //Your database password
define('ZIPSME_DB_NAME', $db_name); //Your database name
define('ZIPSME_DB_HOST', $db_host); //99% chance you won't need to change this
define ('SITE_NAME', 'Your Site'); //The name of your site
define ('SITE_URL', $ltUrl);  //The full URL of the site where Z.ips.ME is installed (including trailing slash)
