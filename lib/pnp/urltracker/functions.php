...
function showLinkHistory() {
	...
	if (($num > 0) || ($num_zero > 0)) {
		if ($num > 0) {
			...
			do {
				echo '<tr>' . "\n";
				echo '<td>' . SITE_URL . prepOutputText($row['url_name']) . '</td>' . "\n";
				echo '<td><span class="badge  badge-success">' . prepOutputText($row['totalCount']) . '</span></td>' . "\n";
				echo '<td><div class="btn-group">
				<a href="?summary=' . $row['url_name'] . '" class="btn btn-success"><i class="icon-search icon-white"></i> View Stats</a>
 <a href="?edit=' . $row['url_name'] . '" class="btn btn-warning"><i class="icon-pencil icon-white"></i> Edit</a>
  
 <a href="?pre_delete=' . $row['url_name'] . '" class="btn btn-danger"><i class="icon-trash icon-white"></i> Delete</a>
</div></td>' . "\n";	
				echo '</tr>' . "\n";
		...
		if ($num_zero > 0) {
			do {
				...
				echo '<td class="border"><span class="badge">0</span></td>' . "\n";
				echo '<td class="border"><div class="btn-group">
				<a href="#" class="btn btn-success disabled"><i class="icon-search icon-white"></i> View Stats</a>
 <a href="?edit=' . $row_zero['noClick'] . '" class="btn btn-warning"><i class="icon-pencil icon-white"></i> Edit</a>
  
 <a href="?pre_delete=' . $row_zero['noClick'] . '" class="btn btn-danger"><i class="icon-trash icon-white"></i> Delete</a>
</div></td>' . "\n";	
				echo '</tr>' . "\n";
