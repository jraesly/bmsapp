...
Updating from a previous version to 1.2:

1. Delete the config.php file from this folder.
2. Upload and overwrite your current version with the entire contents of this folder (except the config.php file of course).
3. Make sure that your database user has permission to ALTER and INDEX.
4. Run update1.2.php in your browser.
