...
<link rel="stylesheet" type="text/css" href="../lib/pnp/todo/themes/default/style.css?v=1.4.2" media="all" />
<?php if(Config::get('rtl')): ?>
<link rel="stylesheet" type="text/css" href="../lib/pnp/todo/themes/default/style_rtl.css?v=1.4.2" media="all" />
<?php endif; ?>
<?php if(isset($_GET['pda'])): ?>
<meta name="viewport" id="viewport" content="width=device-width" />
<link rel="stylesheet" type="text/css" href="../lib/pnp/todo/themes/default/pda.css?v=1.4.2" media="all" />
<?php else: ?>
...
<script type="text/javascript" src="../lib/pnp/todo/jquery/jquery-1.4.4.min.js"></script>
