...
<form class="form-horizontal" id="registerHere" method='post' action=''>
    ...
    <div class="control-group">
	      <label class="control-label" for="input01">Address Line 1</label>
	      <div class="controls">
    ...
    <div class="control-group">
	      <label class="control-label" for="input01">Address Line 2</label>
	      <div class="controls">
    ...
    <div class="control-group">
	      <label class="control-label" for="input01">State/Region</label>
	      <div class="controls">
    ...
    <div class="control-group">
	      ...
	      <div class="controls">
	       <select data-placeholder="Choose a Country..." name="country" class="chzn-select" style="width:250px;" tabindex="2">
          <option value=""></option> 
	...
	<div class="control-group">
		<label class="control-label" for="input01">Confirm Password</label>
	      <div class="controls">
	        <input type="password" class="input-xlarge" id="confirmpassword" name="confirmpassword" rel="popover" data-content="Re-enter your password for confirmation." data-original-title="Re-Password" >
	...
	<div class="control-group">
		<label class="control-label" for="input01"></label>
	      <div class="controls">
	      <img src="../lib/pnp/cc/captcha.php" alt="CAPTCHA security code" id="captcha" /><br />

	       <span class="help-block"><a href="#" onclick="
    document.getElementById('captcha').src='../lib/pnp/cc/captcha.php?'+Math.random();
	...
	<div class="control-group">
		<label class="control-label" for="input01">Enter Above Code</label>
	      <div class="controls">
	        <input type="text" class="input-xlarge" id="captcha" name="captcha" rel="popover" data-content="What’s your email address?" data-original-title="Email">
	...
	<div class="control-group">
		<label class="control-label" for="input01"></label>
	      <div class="controls">
	       <button type="submit" name="submit" class="btn btn-success" rel="tooltip" title="first tooltip">Create My Account</button>
