...
$paginate = _paginate('transactions',"WHERE (ttype='Expense')"); 
...
<div class="span4 well">
  	<legend><span id="stTxt"><?php echo $_L['expensesEntry'];?></span></legend>
    ...
    <div id="rmsg"></div>
        ...
        <div class="control-group">
            <label for="trfrom" class="control-label"><?php echo $_L['Expense_For'];?></label>
            <div class="controls">
                <select name="trfrom"  data-placeholder="Choose an Account" id="trfrom" class="chzn-select" tabindex="2">
                    <option value=""><?php echo $_L['Choose_an_Account'];?></option>
                     <?php
...
?>
        ...
        <div class="control-group">
            <label for="select3" class="control-label"><?php echo $_L['From_Account'];?></label>
            <div class="controls">
...
?>
  ...
  <input name="trtype" id="trtype" type="hidden" value="Expense" />
...
$tr = ORM::for_table('transactions')->where('ttype','Expense')->limit($limit)->offset($startpoint)->order_by_desc('id')->find_many();
